...
export function Navbar({}) {
  return (
    <header>
      <div className="navbar bg-base-100 shadow-lg mx-auto px-4 flex justify-between flex space-x-7 stickyl">
      ...
      <ul tabIndex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
        ...
        <h1 className="flex items-center py-4 px-2 font-semibold text-gray-700 text-2xl hover:text-gray-500">
